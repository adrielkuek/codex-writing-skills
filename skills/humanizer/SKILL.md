---
name: humanizer
description: 'Humanize, rewrite, edit, polish, summarize, synthesize, or transform writing in any form while preserving the intended meaning and voice. Automatically use for any task involving written language, including prose, emails, messages, reports, documentation, README files, papers, LaTeX, slides, captions, scripts, code comments, notes, outlines, tables, structured text, generated datasets, data synthesis, and publication cleanup. Detects 43 AI writing patterns, supports 5 voice profiles, and can output a 0-100 AI-tell score. Pure Markdown, zero dependencies, no network calls.'
allowed-tools:
  - Read
  - Write
  - Edit
